            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="row m">
                            <h2>${this.state.products.price}</h2> &nbsp; &nbsp; <h2 className="text-success">50% off</h2>
                        </div>
                        <div className="row m">
                        ...
                        <Button variant="secondary" onClick={this.addToCart.bind(this, this.state.products)}>Add to cart</Button> &nbsp; &nbsp;
