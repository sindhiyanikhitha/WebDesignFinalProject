      ...
      <div>
        <Jumbotron>
          ...
          <Carousel.Item>
            ...
            />
            <Carousel.Caption>
            <p className="caption"> At We Care, we're redefining what a health plan can do.</p>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
            <p className="caption">We bridge innovation science with state-of-the-art clinical medicine.</p>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
            <p className="caption">The Comfort You Want ... The Services You Need ...</p>
            <h5 className="headCaption">WE CARE</h5>
            </Carousel.Caption>
            </Carousel.Item>
            </Carousel>
                  ...
                  />
                      ...
                      <Card.Body>
                          <Card.Title> Health and Care</Card.Title>
                            <Card.Text>
                            Wellness Miunute blog features daily research-based articles on nutrition and weight loss. Learn about foods you should eat more of, foods to avoid, and the scientific reasoning behind everything the site teaches you.
                            </Card.Text>
                      </Card.Body>
                </Card>
              </Col>
