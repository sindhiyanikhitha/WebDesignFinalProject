        ...
        return (
            <div className="a">
                <Navbar className="nav" expand="md" sticky="top">
                    <Navbar.Brand className="navbarBrand" href="/">WE CARE</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto">
                            ...
                            <NavDropdown title={
                                ...
                                <NavDropdown.Item href="/costestimation">Cost Estimation</NavDropdown.Item>
                            </NavDropdown>
                            <Nav.Link className="navLink" href="/blog">Blog</Nav.Link>
                            <Nav.Link className="navLink" href="/chat">Live Chat</Nav.Link>
